...
class BaseModel(models.Model):
    ...
    #user_delete = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE,related_name='user_delete', null=True, blank=True)

    date_creation = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    date_update = models.DateTimeField(auto_now=True, null=True, blank=True)
    #date_delate = models.DateTimeField(auto_now=True, null=True, blank=True)
