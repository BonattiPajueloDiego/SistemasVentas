...
class UserChangeGroup(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            pass
        return HttpResponseRedirect(reverse_lazy('erp:DashboardView'))
...
class UserPerfilView(LoginRequiredMixin, UpdateView):
    ...
    success_url = reverse_lazy('erp:DashboardView')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['nombre'] = 'Perfil'
        context['list_url'] = self.success_url
        context['action'] = 'edit'
        return context


class UserChangePaswoardView(LoginRequiredMixin, FormView):
    model = User
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['new_password2'].widget.attrs['placeholder'] = 'Respita su Contraseña'
        return form
